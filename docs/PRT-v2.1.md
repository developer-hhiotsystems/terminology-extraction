...
**Milestone 3**: Compare/merge bilingual entries, export to all formats (CSV, Excel, JSON, TBX), verify Neo4j graph compliance and ISO 30042 TBX validation (coverage ≥85%)
